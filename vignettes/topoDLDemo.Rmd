...
![Topo chips examples](figure/topoDLChips-1.png){width=60%}

![Topo mask chips examples](figure/topoDLChips-2.png){width=60%}
...
![Training chips mini-batch](figure/topoDLBatch-1.png){width=60%}

![Training masks mini-batch](figure/topoDLBatch-2.png){width=60%}
...
![Validation chips mini-batch](figure/topoDLBatch-3.png){width=60%}

![Validation masks mini-batch](figure/topoDLBatch-4.png){width=60%}
...
![Loss graph](figure/topoDLLoss-1.png){width=60%}
...
![F1-score graph](figure/topoDLF1-1.png){width=60%}
...
![Recall graph](figure/topoDLRecall-1.png){width=60%}
...
![Precision graph](figure/topoDLPrec-1.png){width=60%}
...
![Chips to predict](figure/topoDLBatchPreds-1.png){width=60%}

![Reference masks](figure/topoDLBatchPreds-2.png){width=60%}

![Predictions](figure/topoDLBatchPreds-3.png){width=60%}

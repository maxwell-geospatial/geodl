...
![Topo map example](figure/topoPlot-1.png){width=60%}
...
![Raster mask example](figure/mskPlot-1.png){width=60%}
...
![Topo chips](figure/chipPlot1-1.png){width=60%}

![Topo chip masks](figure/chipPlot1-2.png){width=60%}
...
![Landcover.ai chips](figure/chipPlot2-1.png){width=60%}

![Landcover.ai mask chips](figure/chipPlot2-2.png){width=60%}
